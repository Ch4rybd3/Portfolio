...
const remoraRoutes = require('./routes/remora')
...
app.use('/api/remora',  remoraRoutes)
...
app.get('/admin/remora',  requireAuth, (req, res) => res.sendFile(path.join(adminDist, 'remora.html')))
...
// Docs — Knowledge Base (SPA)
const docsHtml = path.join(__dirname, '../../public/docs/index.html')
app.get('/docs',   (req, res) => res.sendFile(docsHtml))
app.get('/docs/*', (req, res) => res.sendFile(docsHtml))

// Remora docs (SPA)
const remoraHtml = path.join(__dirname, '../../public/remora/index.html')
app.get('/remora',   (req, res) => res.sendFile(remoraHtml))
app.get('/remora/*', (req, res) => res.sendFile(remoraHtml))
